...
def test_25_metrics():
    ...
    assert metrics['overallBalance'] == 13.01
    assert metrics['avgBalance'] == 6.51
    ...
    assert current_day['dayBalance'] == 13.01
    assert current_day['dayBalancePositive'] == 23.01
    assert current_day['dayBalanceNegative'] == -10.00
